/*
    ...
    Copyright (C) 2009 Frank Edelhaeuser
...
// prototypes
static void flash_wait_poll_uart(void) NOINLINE;
static void flash_write(uint16_t page) NOINLINE;
static void out_char(uint8_t c) NOINLINE;
