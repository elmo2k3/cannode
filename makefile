...
SRC = $(TARGET).c uart.c buttons.c relais.c can_routines.c uart_master.c eeprom.c hr20.c adc.c
...
-Wall -Wstrict-prototypes -Wunused \
-Wa,-adhlns=$(<:.c=.lst) \
...
LDFLAGS = -Wl,-Map=$(TARGET).map,--cref -L../canlib/src -lcan
